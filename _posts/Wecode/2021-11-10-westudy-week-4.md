...
HTML 을 이용해 사용자가 볼 수 있는 웹 문서를 작성하고 CSS 를 이용해 사용자가 보기 편하도록 디자인을 입힙니다. 이렇게 하면 정적인 웹사이트가 만들어집니다. 물론 CSS 애니메이션을 이용하면 움직이는 컨텐츠를 만들수 있지만 사용자와 상호작용을 할 수는 없기 때문에 동적인 웹사이트라고 볼 수 없습니다.

JavaScript 는 이런 정적인 웹사이트를 여러가지 이벤트와 함수를 사용해 사용자와 상호작용 할 수 있는 동적인 웹사이트로 만들어줍니다.
