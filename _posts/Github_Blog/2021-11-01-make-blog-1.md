...
이렇게 하지 않고 그냥 바로 **minimal-mistake** 테마를 fork 해 온 뒤에 **remote** 해도 상관없을 것 같습니다.  
저는 처음 본 게시물을 따라하느라 이렇게 했는데 자신의 깃허브 계정 이름.github.io 폴더에 minimal-mistake 테마 파일들을 넣기만 하면 되니까 편한대로 하시면 될 것 같습니다!
{: .notice}
